...
Project_gfx::Project_gfx(SDL_Renderer* p_rnd, const SP_Config& p_config) {
	...
	klib::gfx::KImage fixed_gfx(klib::file::read_file_as_bytes("appgfx.bin"));
	m_font = klib::gfx::split_surface(p_rnd, fixed_gfx.to_sdl_surface(), 16, 16, true, true, fixed_gfx.get_palette().at(0));
}
