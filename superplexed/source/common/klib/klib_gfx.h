...
namespace klib {
	...
	namespace gfx {
		...
		std::vector<SDL_Texture*> split_surface(SDL_Renderer* p_rnd, SDL_Surface* srf, int p_w, int p_h, bool p_destroy_surface = true, bool p_transparent = false, SDL_Color p_col = COL_TRANSP);
