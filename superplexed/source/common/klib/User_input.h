...
namespace klib {
	...
	namespace c {
		...
		const std::map<SDL_Scancode, int> KEY_DELAYS{ {SDL_SCANCODE_LEFT, DEFAULT_KRV}, {SDL_SCANCODE_DOWN, DEFAULT_KRV}, {SDL_SCANCODE_RIGHT, DEFAULT_KRV}, {SDL_SCANCODE_UP, DEFAULT_KRV}, {SDL_SCANCODE_PAGEDOWN, 2 * DEFAULT_KRV},{SDL_SCANCODE_PAGEUP, 2 * DEFAULT_KRV}, {SDL_SCANCODE_HOME, DEFAULT_KRV},{SDL_SCANCODE_END, DEFAULT_KRV}, {SDL_SCANCODE_KP_MINUS, DEFAULT_KRV}, {SDL_SCANCODE_KP_PLUS, DEFAULT_KRV}, {SDL_SCANCODE_ESCAPE, DEFAULT_KRV}, // movement keys
			{SDL_SCANCODE_C, DEFAULT_KRV }, {SDL_SCANCODE_V, DEFAULT_KRV }, {SDL_SCANCODE_T, 2 * DEFAULT_KRV }, {SDL_SCANCODE_F, 2 * DEFAULT_KRV }, {SDL_SCANCODE_H, 2 * DEFAULT_KRV },{SDL_SCANCODE_DELETE, DEFAULT_KRV },{SDL_SCANCODE_S, DEFAULT_KRV }, {SDL_SCANCODE_M, DEFAULT_KRV }, {SDL_SCANCODE_TAB, DEFAULT_KRV }, {SDL_SCANCODE_H, DEFAULT_KRV }, {SDL_SCANCODE_A, DEFAULT_KRV }, {SDL_SCANCODE_B,2 * DEFAULT_KRV }, {SDL_SCANCODE_R, 1000}, {SDL_SCANCODE_X, 1000 }, {SDL_SCANCODE_D, DEFAULT_KRV}, {SDL_SCANCODE_N, DEFAULT_KRV}, {SDL_SCANCODE_P, DEFAULT_KRV},
